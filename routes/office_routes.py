...
# --- VIEW CLIENT DETAILS (Missing Route) ---
...
def view_client(client_id):
    ...
    for p in props_raw:
        # Simple Compliance Status Check
        gas_stat = 'Valid'
        ...
        properties.append({
            ...
            'compliance': {
                ...
                'PAT': {'status': 'Missing', 'date': '-'} # Placeholder
            }
        })
        
    # 3. Fetch Vans (For the 'New Job' modal in the dashboard)
